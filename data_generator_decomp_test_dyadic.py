...
#
# Code for the data generator of testing data from .mat data type images. Each input image is assumed to be in an individual folder in which 50 ground truth decomposed bands are stored. The GT bands will be combined to 6 dyadic bands in this implementation. 
